...
/**
 * Hook for server-side filter strategy table creation.
 *
...
export const useTable = <T = unknown>({
  ...
  return useReactTable({
    ...
    ...VISIBILITY_OPTIONS,
    ...options,
    enableColumnFilters: true, // check if this is needed.
    enableFilters: true, // check this is needed.
    enableMultiSort: false,
    enableSorting: true, // check this is needed.
