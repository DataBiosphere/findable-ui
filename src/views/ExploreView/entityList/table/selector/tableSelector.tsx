...
/**
 * Table strategy selector for entity list table generation.
 *
 * This component determines which table strategy to use
 ...
 * @returns The selected table strategy component.
 */
export const TableSelector = <T = unknown,>(
  props: TableSelectorProps<T>,
): JSX.Element => {
